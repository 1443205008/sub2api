...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redeemService := service.NewRedeemService(redeemCodeRepository, userRepository, subscriptionService, redeemCache, billingCacheService, client, settingService, apiKeyAuthCacheInvalidator)
