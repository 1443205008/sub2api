...
func init() {
	...
	// groupDescRateTimeRules is the schema descriptor for rate_time_rules field.
	groupDescRateTimeRules := groupFields[7].Descriptor()
	// group.DefaultRateTimeRules holds the default value on creation for the rate_time_rules field.
	group.DefaultRateTimeRules = groupDescRateTimeRules.Default.([]domain.GroupRateTimeRule)
