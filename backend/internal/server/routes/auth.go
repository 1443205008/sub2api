...
func RegisterAuthRoutes(
	...
	auth.Use(servermiddleware.BackendModeAuthGuard(settingService))
	{
		...
		auth.GET("/registration-captcha", rateLimiter.LimitWithOptions("auth-registration-captcha", 20, time.Minute, middleware.RateLimitOptions{
			FailureMode: middleware.RateLimitFailClose,
		}), h.Auth.GetRegistrationCaptcha)
