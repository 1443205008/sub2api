export default {
  ...
  admin: {
    ...
    users: {
      ...
      bulk: {
        ...
        apply: 'Bulk Apply',
        title: 'Bulk Manage Users ({count})',
        noSelection: 'Select users first',
        status: 'Target Status',
        balanceOperation: 'Balance Operation',
        balanceAdd: 'Add Balance',
        balanceSubtract: 'Subtract Balance',
        balanceSet: 'Set Balance',
        balanceAmount: 'Balance Amount',
        concurrency: 'Concurrency',
        invalidRpmLimit: 'RPM must be greater than or equal to 0',
        deleteWarning: 'This will delete {count} selected user(s). Admin accounts are rejected by the backend. This action cannot be undone.',
        success: 'Bulk operation completed: {success} succeeded, {failed} failed',
        partialFailed: '{count} user(s) failed. First error: {message}',
    ...
    settings: {
      ...
      payment: {
        ...
        rechargeBonusTiersHint: 'Grant extra balance when recharge amount is greater than or equal to the threshold. If multiple thresholds match, the highest threshold wins.',
        rechargeBonusTiersEmpty: 'No bonus tiers. Users receive balance only by the base multiplier.',
        tierMinAmount: 'Recharge threshold',
        tierMaxAmount: 'Max recharge amount',
        tierBonusPercent: 'Extra bonus percent',
  ...
  payment: {
    ...
    rechargeBonusBadge: 'Recharge Bonus',
    rechargeBonusAvailableTitle: 'Top up more to unlock higher bonus tiers',
    rechargeBonusMatchedTitle: '+{percent}% recharge bonus matched',
    rechargeBonusMatchedDesc: 'Extra ${bonus} bonus, estimated credited balance ${credited}',
    rechargeBonusNextTier: 'Top up ¥{amount} to get an extra {percent}% bonus',
    rechargeBonusNoMatch: 'The current amount does not match any bonus tier',
    rechargeBonusExtra: 'Extra Bonus',
    rechargeBonusTierRange: '¥{min}-¥{max}: +{percent}%',
    rechargeBonusTierNoLimit: '¥{min}+: +{percent}%',
    rechargeBonusTierThreshold: '¥{min}+: +{percent}%',
    rechargeBonusPreview: 'Bonus tier matched: extra {percent}% (~${bonus}), estimated credited ${credited}',
