  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        rechargeBonusTiersHint: 'Grant extra balance by recharge amount. Set max amount to 0 for no upper limit. Credited multiplier = base multiplier + bonus percent.',
        rechargeBonusTiersEmpty: 'No bonus tiers. Users receive balance only by the base multiplier.',
        tierMinAmount: 'Min recharge amount',
