export default {
  ...
  auth: {
    ...
    imageCaptchaLabel: '图片验证码',
    imageCaptchaPlaceholder: '请输入图片中的字符',
    imageCaptchaHint: '看不清可点击刷新验证码',
    imageCaptchaRequired: '请输入图片验证码',
    imageCaptchaInvalid: '图片验证码错误或已过期，请重试',
    imageCaptchaLoadFailed: '加载图片验证码失败，请刷新重试',
    linuxdo: {
  ...
  profile: {
    ...
    invite: {
      ...
      recordsTitle: '邀请记录',
      recordsDescription: '查看被邀请用户的注册与返现情况。',
      noRecords: '暂无邀请记录',
      unknownUser: '未知用户',
      recordStatus: '状态筛选',
      ...
      dateTo: '结束日期',
      resetFilters: '重置筛选',
      sortRegisteredDesc: '注册时间：最新优先',
      sortRegisteredAsc: '注册时间：最早优先',
      sortCashbackDesc: '最近返现：最新优先',
      sortCashbackAsc: '最近返现：最早优先',
      sortAmountDesc: '返现金额：高到低',
      sortAmountAsc: '返现金额：低到高',
      registeredAt: '注册时间',
      recordCashback: '累计返现',
      cashbackCount: '返现 {count} 次',
      lastCashbackAt: '最近返现',
      noCashbackYet: '暂无返现',
      recharged: '已充值',
      notRecharged: '未充值'
  ...
  admin: {
    ...
    users: {
      ...
      bulkDeleteSuccess: '成功删除 {count} 个用户',
      bulkDeletePartial: '部分删除成功：成功 {success} 个，失败 {failed} 个',
      bulkDeleteFailed: '批量删除用户失败',
      bulkEnableSuccess: '成功启用 {count} 个用户',
      bulkEnablePartial: '部分启用成功：成功 {success} 个，失败 {failed} 个',
      bulkEnableFailed: '批量启用用户失败',
      bulkDisableSuccess: '成功禁用 {count} 个用户',
      bulkDisablePartial: '部分禁用成功：成功 {success} 个，失败 {failed} 个',
      bulkDisableFailed: '批量禁用用户失败',
      bulkDepositSuccess: '成功为 {count} 个用户充值',
      bulkDepositPartial: '部分充值成功：成功 {success} 个，失败 {failed} 个',
      bulkDepositFailed: '批量充值失败',
      bulkWithdrawSuccess: '成功为 {count} 个用户退款',
      bulkWithdrawPartial: '部分退款成功：成功 {success} 个，失败 {failed} 个',
      bulkWithdrawFailed: '批量退款失败',
      userEnabled: '用户已启用',
      userDisabled: '用户已禁用',
      ...
      bulkBalance: {
        depositTitle: '批量充值',
        withdrawTitle: '批量退款',
        selectedInfo: '将对选中的 {count} 个用户执行该操作。',
        partialHint: '若部分用户不满足条件（如管理员保护或余额不足），系统会跳过并返回失败结果。',
        confirmDeposit: '确认批量充值',
        confirmWithdraw: '确认批量退款'
      },
      // Settings Dropdowns
      filterSettings: '筛选设置',
      columnSettings: '列设置',
    ...
    redeem: {
      ...
      failedToLoadInviteRanking: '加载邀请排行榜失败',
      failedToCopy: '复制失败',
      selectGroup: '选择分组',
      ...
      inviteRankingTitle: '全站邀请排行榜',
      inviteRankingDescription: '查看全站邀请返现表现，按邀请人数或返现金额排序。',
      inviteRankingSearch: '搜索邀请人邮箱 / 用户名 / ID',
      inviteRankingStatusAll: '全部状态',
      noInviteRanking: '暂无邀请排行榜数据',
      noCashbackYet: '暂无返现',
      recharged: '已返现',
      notRecharged: '未返现',
      sortTotalCashbackDesc: '返现金额：高到低',
      sortTotalCashbackAsc: '返现金额：低到高',
      sortInvitedUsersDesc: '邀请人数：多到少',
      sortInvitedUsersAsc: '邀请人数：少到多',
      sortLastInviteDesc: '最近邀请：最新优先',
      sortLastInviteAsc: '最近邀请：最早优先',
      sortLastCashbackDesc: '最近返现：最新优先',
      sortLastCashbackAsc: '最近返现：最早优先',
      form: {
        typeLabel: '类型',
        selectType: '选择类型',
        valueLabel: '面值',
    ...
    settings: {
      ...
      emailTabDisabledTitle: '邮箱功能未启用',
      emailTabDisabledHint: '请在「安全与认证」选项卡中启用邮箱验证或注册验证码后，再配置 SMTP 设置。',
      registration: {
        title: '注册设置',
        ...
        emailVerificationHint: '启用邮箱验证能力，用于找回密码、TOTP 邮箱验证等功能',
        registrationVerifyCode: '注册邮箱验证码',
        registrationVerifyCodeHint: '开启后，用户注册时需先获取邮箱验证码',
        registrationImageCaptcha: '注册图片验证码',
        registrationImageCaptchaHint: '开启后，用户注册时需输入图片中的验证码字符',
        ...
        singleIPRegistrationLimit: '单 IP 注册限制',
        singleIPRegistrationLimitHint: '开启后，同一 IP 仅允许注册一个账号',
        passwordReset: '忘记密码',
