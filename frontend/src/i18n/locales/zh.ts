export default {
  ...
  admin: {
    ...
    users: {
      ...
      bulk: {
        ...
        balanceAdd: '增加余额',
        balanceSubtract: '扣减余额',
        balanceSet: '设置余额',
        balanceAmount: '余额金额',
        concurrency: '并发数',
        invalidRpmLimit: 'RPM 必须大于或等于 0',
        deleteWarning: '将删除已选 {count} 个用户。管理员账号会被后端自动拒绝。此操作无法撤销。',
        success: '批量操作完成：成功 {success}，失败 {failed}',
        partialFailed: '{count} 个用户处理失败，首个错误：{message}',
        failed: '批量操作失败',
        actions: {
          setStatus: '设置状态',
          adjustBalance: '调整余额',
    ...
    settings: {
      ...
      payment: {
        ...
        rechargeBonusTiers: '充值奖励档位',
        rechargeBonusTiersHint: '充值金额大于等于指定门槛时，额外赠送对应百分比余额；命中多个门槛时按最高门槛那一档计算。',
        rechargeBonusTiersEmpty: '暂无奖励档位，用户仅按基础倍率到账。',
        tierMinAmount: '充值满金额',
        tierMaxAmount: '最高充值金额',
        tierBonusPercent: '额外奖励比例',
  ...
  payment: {
    ...
    rechargeBonusBadge: '充值奖励',
    rechargeBonusAvailableTitle: '多充多送，自动匹配最高奖励档位',
    rechargeBonusMatchedTitle: '已命中 +{percent}% 充值奖励',
    rechargeBonusMatchedDesc: '本次额外赠送 ${bonus}，预计到账 ${credited}',
    rechargeBonusNextTier: '充值满 ¥{amount} 可享额外 {percent}% 奖励',
    rechargeBonusNoMatch: '当前金额暂未命中奖励档位',
    rechargeBonusExtra: '额外奖励',
    rechargeBonusTierRange: '¥{min}-¥{max}：+{percent}%',
    rechargeBonusTierNoLimit: '¥{min}以上：+{percent}%',
    rechargeBonusTierThreshold: '满 ¥{min}：+{percent}%',
    rechargeBonusPreview: '已命中奖励档位：额外赠送 {percent}%（约 ${bonus}），预计到账 ${credited}',
    refundReason: '退款原因',
